from Classes.Packets.Client.ClientHelloMessage import ClientHelloMessage
from Classes.Packets.Client.LoginMessage import LoginMessage
from Classes.Packets.Client.AskForBattleEndMessage import AskForBattleEndMessage
from Classes.Packets.Client.ChangeAvatarNameMessage import ChangeAvatarNameMessage
from Classes.Packets.Client.EndClientTurnMessage import EndClientTurnMessage
from Classes.Packets.Client.GoHomeFromOfflinePractiseMessage import GoHomeFromOfflinePractiseMessage
from Classes.Packets.Client.GoHomeMessage import GoHomeMessage
from Classes.Packets.Client.GetPlayerProfileMessage import GetPlayerProfileMessage
from Classes.Packets.Client.AskForAllianceDataMessage import AskForAllianceDataMessage
from Classes.Packets.Client.KeepAliveMessage import KeepAliveMessage
from Classes.Packets.Server.LoginFailedMessage import LoginFailedMessage
from Classes.Packets.Server.LoginOkMessage import LoginOkMessage
from Classes.Packets.Server.OutOfSyncMessage import OutOfSyncMessage
from Classes.Packets.Server.ServerHelloMessage import ServerHelloMessage
from Classes.Packets.Server.BattleEndMessage import BattleEndMessage
from Classes.Packets.Server.AvailableServerCommandMessage import AvailableServerCommandMessage
from Classes.Packets.Server.LobbyInfoMessage import LobbyInfoMessage
from Classes.Packets.Server.OwnHomeDataMessage import OwnHomeDataMessage
from Classes.Packets.Server.KeepAliveServerMessage import KeepAliveServerMessage
from Classes.Packets.Server.PlayerProfileMessage import PlayerProfileMessage
from Classes.Packets.Server.MyAllianceMessage import MyAllianceMessage
from Classes.Packets.Server.AllianceDataMessage import AllianceDataMessage
...
class MessageFactory:
    ...
    def getMessageName(messageType):
        try:
            message = MessageFactory.messagesList[messageType]
        except KeyError:
    ...
    def messageExist(messageType):
        return (messageType in MessageFactory.messagesList.keys())

    def createMessageByType(messageType, messagePayload):
        messagesList = MessageFactory.messagesList
        if MessageFactory.messageExist(messageType):
            if type(messagesList[messageType]) == str:
                print(MessageFactory.getMessageName(messageType), "skipped")
            else:
                print(MessageFactory.getMessageName(messageType), "created")
