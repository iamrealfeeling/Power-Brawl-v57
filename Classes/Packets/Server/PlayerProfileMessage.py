...
class PlayerProfileMessage(PiranhaMessage):
    ...
    def encode(self, fields, player):
        ...
        self.writeString(player.ProfileData["Name"])  #PlayerInfo
        self.writeVInt(100)
        self.writeVInt(28000000 + player.ProfileData["Thumbnail"])
        self.writeVInt(43000000 + player.ProfileData["Namecolor"])
        self.writeVInt(14)
